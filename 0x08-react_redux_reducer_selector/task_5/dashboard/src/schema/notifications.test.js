...
describe('Calling the notifications', () => {
  it('Reading the data', () => {
    const data = [
      {
    ...
    const Contexts = getAllNotificationsByUser('5debd764a7c57c7839d722e9');
    expect(Contexts).toEqual(expect.arrayContaining(data));
  });

  it('Normalizing Data - result', () => {
    const data = [
  ...
  it('Normalizing Data - notifications', () => {
    const data = {
